...
COPY ./requirements.txt /etc/PireAgenda/requirements.txt
...
ENTRYPOINT gunicorn -b 0.0.0.0:8000 -k uvicorn.workers.UvicornWorker --forwarded-allow-ips "*" src.main:app --threads 2 --workers 1 --timeout 1000 --graceful-timeout 30
